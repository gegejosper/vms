...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                ...
                <div class="x_content"> 
                <form action="{{ route('addvoters') }}" method="post">  
                {{ csrf_field() }}
                                    ...
                                    <div id="field form-row">
                                        <div id="field0" class="row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <div class="">
                                                    <input id="nmane" name="nmane" type="text" placeholder="" class="form-control input-md" required>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-2">
                                            <label class="control-label" for="Barangay">Barangay</label>
                                                <div class="">
                                                    ...
                                                    <select name="slc1" id="slc1" onchange="_1sel();" class="form-control"></select>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-2">
                                            <label class="control-label" for="Precinct">Precinct</label>
                                                <div class="">
                                                    <select name="slc2" id="slc2" class="form-control"></select>    
                                                </div>
                                            </div>
