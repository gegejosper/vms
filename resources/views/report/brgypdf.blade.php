        ...
        <div class="x_panel">
                ...
                <div class="x_panel">
                        ...
                        <div class="col-md-4 col-xs-12 widget widget_tally_box">
                          <div class="x_panel">
                            <div class="x_title">
                              <h2><a href="/brgy/{{$brgy['brgy']}}">{{$brgy['brgy']}}</a></h2>
                              <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                              ...
                              <ul class="legend list-unstyled">
                                <li>
                                  <p>
                                    <span class="icon"><i class="fa fa-square green"></i></span> <span class="name">Voters ( {{ $brgy['opponent'] + $brgy['supporter']}} )</span>
                                  </p>
                                </li>
                                <li>
                                  <p>
                                    <span class="icon"><i class="fa fa-square red"></i></span> <span class="name">Supportes ( {{ $brgy['supporter']}} )</span>
                                  </p>
                                </li>
                                <li>
                                  <p>
